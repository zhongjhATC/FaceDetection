...
public class FinanceConfigUtils {
    ...
    // 配置文件路径
    public static final String filePath = folder + "/" + "financeFaceConfig.txt";
...
//            int radius = (int) jsonObject.get("radius");
            ...
            int framesthreshold = Integer.valueOf(jsonObject.get("framesthreshold") + "");
            if (framesthreshold < 1 || framesthreshold > 10) {
                return false;
            }
