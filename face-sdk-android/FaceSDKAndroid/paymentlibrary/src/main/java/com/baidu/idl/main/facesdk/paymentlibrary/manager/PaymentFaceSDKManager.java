...
public class PaymentFaceSDKManager {
    ...
    private static class HolderClass {
        private static final PaymentFaceSDKManager instance = new PaymentFaceSDKManager();
    }

    public static PaymentFaceSDKManager getInstance() {
    ...
    public void onDetectCheck(final byte[] rgbData,
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                FaceInfo[] faceInfos = PaymentFaceSDKManager.getInstance().getFaceDetect()
        ...
        future2 = es2.submit(new Runnable() {
            ...
            public void run() {
                ...
                bdFaceDetectListConfig.usingQuality = bdFaceDetectListConfig.usingHeadPose
                        = SingleBaseConfig.getBaseConfig().isQualityControl();
                FaceInfo[] faceInfos = PaymentFaceSDKManager.getInstance()
                        .getFaceDetect()
                ...
                if (liveCheckMode != 0) {
                    ...
                    rgbScore = PaymentFaceSDKManager.getInstance().getFaceLiveness().silentLive(
...
//                    LogUtils.e(TIME_TAG, "detect ir time = " + livenessModel.getIrLivenessDuration());
                    ...
                    if (faceInfosIr != null && faceInfosIr.length > 0) {
                        ...
                        nirScore = PaymentFaceSDKManager.getInstance().getFaceLiveness().silentLive(
...
//                        LogUtils.e(TIME_TAG, "live ir time = " + livenessModel.getIrLivenessDuration());
                ...
                if (liveCheckMode == 3 || liveCheckMode == 4 && depthData != null) {
                    ...
                    if (SingleBaseConfig.getBaseConfig().getCameraType() == 1) {
                        depthScore = PaymentFaceSDKManager.getInstance().getFaceLiveness().silentLive(
...
//                LogUtils.e(TIME_TAG, "all process time = " + livenessModel.getAllDetectDuration());
    ...
    private void onFeatureCheck(BDFaceImageInstance rgbInstance,
        ...
        if (featureType == 3) {
            ...
            PaymentFaceSDKManager.getInstance().getImageIllum().imageIllum(rgbInstance, atomicInteger);
            ...
            if (illumScore > SingleBaseConfig.getBaseConfig().getIllumination()) {
                if (faceInfos != null) {
                    ...
                    float featureSize = PaymentFaceSDKManager.getInstance().getFaceFeature().feature(
    ...
    private void featureSearch(final int featureCheckMode,
        ...
        if (featureSize == FEATURE_SIZE / 4) {
            ...
            ArrayList<Feature> featureResult =
                    PaymentFaceSDKManager.getInstance().getFaceFeature().featureSearch(feature,
                            type, 1, true);
