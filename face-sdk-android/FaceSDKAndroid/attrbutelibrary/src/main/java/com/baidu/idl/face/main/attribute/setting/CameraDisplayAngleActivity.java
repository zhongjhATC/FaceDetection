    ...
    public void init() {
        ...
        PWTextUtils.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                cwCameraDisplay.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
            }
        });
        ...
        cwCameraDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwCameraDisplay.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
