    ...
    public void init() {
        ...
        PWTextUtils.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                cwdetectangle.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
            }
        });
        ...
        cwdetectangle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwdetectangle.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
